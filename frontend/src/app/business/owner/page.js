...
function BusinessOwnerPageContent() {
    ...
    useEffect(() => {
        ...
        if (isOwner) {
            // Fetch multiple restaurants for owner
            fetchRestaurants();
        } else {
            // Staff logic handled elsewhere (redirected by BusinessRestaurants)
        }
    }, [isAuthenticated, user, fetchRestaurants]);
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex justify-between items-end mb-6">
                ...
                {/* Allow ONLY Owners to add restaurants */}
                        ...
                        return (
                            <div key={restro._id} className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-slate-800 group hover:border-sunset/50 transition-colors">
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-slate-800">
                                    ...
                                    <button
                                        onClick={() => router.push(`/business/owner/restros/${restro._id}`)}
